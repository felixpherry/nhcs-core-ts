...
- App Session originally captured `accessToken`, `userId`, `accessId`, and `userLevel` for Backend Session Headers; phase 5 expanded it with normalized `menuGroups` for navlink rendering.
